    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('HR', 'Human Resources'), ('DEV', 'Development'), ('COM', 'Communication'), ('VIS', 'visuals'), ('LOG', 'Logistics'), ('RLX', 'External Relations')], max_length=3)),
